CLASS zku_cl_travel_generator DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    INTERFACES if_oo_adt_classrun.
ENDCLASS.

CLASS zku_cl_travel_generator IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA travel   TYPE zku_travel_a.
    DATA travels  TYPE TABLE OF zku_travel_a.
    DATA booking  TYPE zku_booking_a.
    DATA bookings TYPE TABLE OF zku_booking_a.

    " Delete Travels
    DELETE FROM zku_travel_a.
    out->write( |Deleted Travels: { sy-dbcnt }| ).

    " Delete Bookings
    DELETE FROM zku_booking_a.
    ...
    " Insert Travels
    INSERT zku_travel_a FROM TABLE @travels.
    out->write( |Inserted Travels: { sy-dbcnt }| ).

    " Insert Bookings
    INSERT zku_booking_a FROM TABLE @bookings.
