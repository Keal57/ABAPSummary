...
define root view entity ZKU_R_Travel
  as select from zku_travel_a
  composition [0..*] of ZKU_R_Booking as _Bookings
  association [1..1] to ZKU_I_CustomerText as _CustomerText on $projection.CustomerId = _CustomerText.CustomerId
